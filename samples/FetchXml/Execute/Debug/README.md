...
2. import execute.html file to Offline HTML section of your Woodford project <br />[execute.html file](https://github.com/Resconet/JSBridge/blob/master/samples/FetchXml/Execute/execute.html)

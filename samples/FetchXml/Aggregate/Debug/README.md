...
2. import aggregation.html file to Offline HTML section of your Woodford project <br />[aggregation.html file](https://github.com/Resconet/JSBridge/blob/master/samples/FetchXml/Aggregate/aggregation.html)
3. go to Home form in Woodford
4. tap on 'Add IFrame' command
5. set IFrame name to Aggregate_example
6. tap on 'Browse' button and select aggregation.html file

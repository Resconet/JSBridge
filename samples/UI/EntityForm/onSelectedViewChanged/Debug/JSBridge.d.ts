...
declare module MobileCRM.UI {
	...
	*/
	class EntityForm {
		...
		* @param scope The scope for callback.
		*/
        static selectTabEx(tabName: string, errorCallback?: (err: string) => void, scope?: any);
		/**
		...
		* @param scope The scope for callbacks.
		*/
		public static onSelectedViewChanged: (handler: (entityForm: EntityForm) => void, bind: boolean, scope?: any) => void;
	}

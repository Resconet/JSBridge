...
function createDetailViewItems() {
    MobileCRM.UI.EntityForm.requestObject((entityForm) => {
        ...
        let detailView = entityForm.getDetailView("Items");
        if (detailView) {
            ...
            let separator = new MobileCRM.UI.DetailViewItems.SeparatorItem();
            ...
            let dateItem = new MobileCRM.UI.DetailViewItems.DateTimeItem();
...
function createLinkDetailItems() {
    MobileCRM.UI.EntityForm.requestObject((entityForm) => {
        ...
        if (detailView) {
            ...
            let ind1 = detailView.getItemIndex("linkHrefItem");
            if (ind1 && ind1 > -1) {
                ...
                detailView.registerClickHandler(linkHrefItem, (itemName) => {
            ...
            let ind2 = detailView.getItemIndex("linkRefItem");
            if (ind2 && ind2 > -1) {
                ...
                detailView.registerClickHandler(linkRefItem, (itemName, detailView) => {
                    if (itemName === linkRefItem.name) {
                        ...
                        let refValue = linkRefItem.value as MobileCRM.Reference;
                        if (refValue)
